...
class Login_Window(QDialog):
    ...
    def __init__(self):
        super().__init__()
        self.text, ok = QInputDialog.getText(self, '아이디를 입력', 'Your ID:')
    ...
    def initUI(self):
        ...
        self.btn_on = QPushButton("로그인", self)
    ...
    def nextFrameSlot(self):
        ...
        for face in face_list:
            ...
            # 이미지를 저장
            file_name_path = 'Test/login' + '/' + 'login_image' + '.' + str(Login_Window.count) + '.png'
